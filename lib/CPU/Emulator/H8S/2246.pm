...
sub _handlers {
  ...
  return c({
    ...
    handler_for => {
      ...
      0xB000_0000_0000_0000 => \&_op_subx_b_xx8_rd,
      0xC000_0000_0000_0000 => \&_op_or_b_xx8_rd,
      0xD000_0000_0000_0000 => \&_op_xor_b_xx8_rd,
    ...
    handler_for => {
      ...
      0x0500_0000_0000_0000 => \&_op_xorc_b_xx8_ccr,
      ...
      0x1500_0000_0000_0000 => \&_op_xor_b_rs_rd,
      ...
      0x1E00_0000_0000_0000 => \&_op_subx_b_rs_rd,
      ...
      0x6500_0000_0000_0000 => \&_op_xor_w_rs_rd,
    ...
    mask => 0xFFCF_0000_0000_0000,
    handler_for => {
      0x5700_0000_0000_0000 => \&_op_trapa_xx2,
    },
  }, {
    ...
    handler_for => {
      ...
      0x7950_0000_0000_0000 => \&_op_xor_w_xx16_rd,
    ...
    handler_for => {
      ...
      0x7A50_0000_0000_0000 => \&_op_xor_l_xx32_erd,
    ...
    handler_for => {
      ...
      0x0141_0500_0000_0000 => \&_op_xorc_b_xx8_exr,
    ...
    handler_for => {
      ...
      0x01F0_6500_0000_0000 => \&_op_xor_l_ers_erd,
    ...
    handler_for => {
      ...
      0x01E0_7B0C_0000_0000 => \&_op_tas_b_Aerd,
    },
  }, {
